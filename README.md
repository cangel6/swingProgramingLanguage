...
2-2. "와", "과"로 한번에 여러 변수명을 할당할 수 있다.</br>
2-3. 조사 "은", "는" 은 변수명에 값을 할당하는 명령이다.</br>
2-4. 조사 "이", "가" 는 변수명에 값을 더하는 명령이다.</br>
2-5. 조사 "을", "를" 은 변수명에 값을 빼는 명령이다.</br>
2-6. 할당, 가산, 감산 명령어가 나온 이후의 주어는 변수명으로 사용되지 않는다.</br>
</br>
3. 어휘.</br>
...
새로운 것은 여러 사람에게 발전되어 가고 넓어질 거라 생각한다. ㅍ
